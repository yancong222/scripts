...
with open ('minimal pairs - manner implicature.csv', newline='') as f:
    ...
    for line in reader:
        ...
        if 0 < l < 25: #change here for different conditions; sept 24
            ...
            sentence = line['pre_cw'] + ' <extra_id_0> ' #remove period and </s> for sentence
...
#print('first loss diff: ', first_loss_difference_lst)
            ...
            baseline_sentence = line['pre_cw'] + ' <extra_id_0> '
...
#print('second loss lst: ', second_loss_difference_lst)
                        
#print(first_loss_difference_lst)
#print(second_loss_difference_lst)
loss_difference_lst = first_loss_difference_lst + second_loss_difference_lst
#print(loss_difference_lst)
